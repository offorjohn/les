...
<section class="scrollable">
    <section class="panel panel-default padder contentTop">
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-4 show-mon">
            <div class="pull-left m-b-xs  coursetitle"> <span class="orange_heading"><strong>My Profile</strong></span>
            </div>
        </div>
        <div class="col-lg-6  col-md-6 col-sm-6  col-xs-8 padd0">
                        <a onFocus='this.blur()' onMouseOver='return showStatus();' href="modify.php" title="Modify your  profile"
                class="pull-right btn btn-lg btn-default bdrRadius20 marginLeft5">Modify
                Profile</a>

                        <a onFocus='this.blur()' onMouseOver='return showStatus();' href="chgpwd.php" title="Change your password"
                class="pull-right btn btn-lg btn-default bdrRadius20 marginLeft5">Change
                Password</a>

        </div>
        <div class="clear"> </div>
        <div class="col-lg-12 col-md-12 col-sm-12 text-left paddTop10">
        ...
        <div class="col-md-12 col-sm-12 paddTop10">
            ...
            <table class="table-responsive">
                ...
                <tr>
                    ...
                    <td class="col-sm-9">
                        offorchukwuebuka8@gmail.com                    </td>
                ...
                <tr>
                    <td class="col-sm-2 ContentBold">Zip Code:</td>
                    <td class="col-sm-9">
                        -                    </td>
                ...
                <!-- <tr>
                    <td class="col-sm-2 ContentBold">Allow email for campaign:</td>
                    <td class="col-sm-9">
                    No                    </td>
                ...
                <!-- <tr>
                    <td class="col-sm-2 ContentBold">Occupation:</td>
                    <td class="col-sm-9">
                                            </td>
